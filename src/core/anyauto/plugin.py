...
from anyauto.chatgpt_registration_mode_adapter import (
...
class ChatGPTPlatform(BasePlatform):
    ...
    def check_valid(self, account: Account) -> bool:
        try:
            from anyauto.payment import check_subscription_status
    ...
    def execute_action(self, action_id: str, account: Account, params: dict) -> dict:
        ...
        if action_id == "probe_local_status":
            from anyauto.status_probe import probe_local_chatgpt_status
        ...
        if action_id == "sync_cliproxyapi_status":
            from ...services.chatgpt_sync import sync_chatgpt_cliproxyapi_status
        ...
        if action_id == "refresh_token":
            from anyauto.token_refresh import TokenRefreshManager
        ...
        if action_id == "payment_link":
            from anyauto.payment import generate_plus_link, generate_team_link
        ...
        if action_id == "upload_cpa":
            from anyauto.cpa_upload import generate_token_json, upload_to_cpa
        ...
        if action_id == "upload_sub2api":
            from anyauto.sub2api_upload import upload_to_sub2api
        ...
        if action_id == "upload_tm":
            from anyauto.cpa_upload import upload_to_team_manager
        ...
        if action_id == "upload_codex_proxy":
            ...
            if upload_type == "rt":
                from anyauto.cpa_upload import upload_to_codex_proxy
                ...
                from anyauto.cpa_upload import upload_at_to_codex_proxy
